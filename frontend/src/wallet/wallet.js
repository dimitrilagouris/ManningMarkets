...
function Wallet({ walletData, transactions, positions }) {
              ...
              <div className="wallet-balance-info" aria-labelledby="wallet-overview-heading">
                ...
                <div className="wallet-balance-list">
                  <div className="wallet-balance-item">
                    ...
                    <div className="wallet-balance-value">{fmt(walletData.balance)} pts</div>
                  </div>

                  <div className="wallet-balance-item">
                    <div className="wallet-balance-label">Currently allocated</div>
                    <div className="wallet-balance-value">{fmt(walletData.allocated)} pts</div>
                  </div>

                  <div className="wallet-balance-item">
                    <div className="wallet-balance-label">Available for trading</div>
                    <div className="wallet-balance-value">{fmt(walletData.unallocated)} pts</div>
                  </div>
                </div>
              </div>

              <div className="wallet-chart-container" aria-hidden="true">
                <PieChart allocated={walletData.allocated} unallocated={walletData.unallocated} />
              </div>
            </section>
...
Wallet.propTypes = {
  ...
  positions: PropTypes.arrayOf(
      PropTypes.shape({
        ...
        currentOdds: PropTypes.string.isRequired,
        potentialReturn: PropTypes.number.isRequired,
      })
  ).isRequired,
};
